...
- Complex API interactions ΓåÆ use http-request
- Browser testing ΓåÆ use browser-tools
- DNS lookups ΓåÆ use dig/nslookup
- Port scanning ΓåÆ use network tools
...
```
Γ£à https://api.example.com/health (200, 145ms)
```
...
--------------------------------|--------|--------|--------
https://api.example.com/health    | 200    | 145ms  | Γ£à
https://api.example.com/status    | 200    | 132ms  | Γ£à
```
