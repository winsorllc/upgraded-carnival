...
- Scheduling agent tasks or alerts → use `cron` tool with systemEvent instead
...
**Ask:** "Do you want this in Apple Reminders (syncs to your phone) or as an agent alert (I'll message you here)?"

- Apple Reminders → use this skill
- Agent alert → use `cron` tool with systemEvent
